/**
 * A calculator that displays the number of fragments needed for any given IP Data Packet size and MTU.
 * It also calculates the values of Total Length, MF Flag, Offset.
 *
 * @author Ful Al Sayab
 **/
